...
def appendData(data):
	...
	accel0 = np.array([long(data[0])-time,float(data[1]),float(data[2]),float(data[3]),float(data[13]),float(data[14]),float(data[15]),float(data[4]),float(data[5]),float(data[6])])
